...
public class ShoppingCartController {
  ...
  public String addItem(@ModelAttribute("book") Book book, @ModelAttribute("qty") String qty, Model model, Principal principal) {
    ...
    if (Integer.parseInt(qty) > book.getInStockNumber()) {
      ...
      return "forward:/bookDetail?id=" + book.getId(); // We can also use redirect instead of forward
    }

    CartItem cartItem = cartItemService.addBookToCardItem(book, user, Integer.parseInt(qty));
